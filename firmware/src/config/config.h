...
#define SEARCH_STRAIGHT_MAX_VELOCITY			0.31f
...
#define FAST_STRAIGHT_MAX_VELOCITY			0.5f
...
#define TRACKING_CONTROL_Y_P_GAIN			10.0f
...
#define TRACKING_CONTROL_WALL_FILTER_GAIN	0.02f //小さいほど平滑化される
#define TRACKING_CONTROL_WALL_TO_OMEGA_GAIN	0.002f
